var images = [
    "url(img/medium-shot-business-women-high-five.jpeg)",
    "url(img/team-meeting-renewable-energy-project.jpeg)",
    "url(img/two-business-partners-working-together-office-computer.jpeg)",
];
